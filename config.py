...
class Config(object):
    SECRET_KEY = os.environ.get('SECRET_KEY') or '32245e65-87f7-4797-b4d3-2c61795c7df0'
    ...
    CLIENT_SECRET = "umv8Q~bQG5GEHmCchuIKkf2GioPiFAIhaMbvyc2B"
    ...
    CLIENT_ID = "34f481c3-524c-4189-84db-bc3ec37cd74e"
